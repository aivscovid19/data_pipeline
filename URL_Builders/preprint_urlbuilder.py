# -*- coding: utf-8 -*-
"""preprint_URLBuilder.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Ew3OLDPu-sqATkOxN7Zk_PFlGwDKJTk6
"""
...
project_id='for-yr'
table_id=f'Medical_Dataset.preprint_url22'
schema = [
...
class URL_builder():
  ...
  def __init__(self,search_word,pages):
    ...
    max_pages=pages+1
    url_search=f"https://www.preprints.org/search?search1={search_word}&field1=article_abstract&field2=authors&clause=AND&search2=&".format(search_word)
    article_set = set()
    ...
    for page_num in range(1,max_pages):
      ...
      articles = mining.Element("css_selector","a#title.title").get_attribute('href')
      urls = mining.CollectURLs(url, articles, driver_path=driver_path)
      [self.url1.append(i) for i in urls]
      print(type(urls))
      self.url_schema=pd.DataFrame({'article_url': urls})
    ...
    self.url_schema['timestamp']= str(datetime.utcnow())
...
urls=URL_builder('coronavirus',2)
