# -*- coding: utf-8 -*-
"""Medrxiv_URLBuilder.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SDOt9wALH2tkxqQ1rsiQE24vn3ZJfAop
"""
...
project_id='for-yr'
table_id=f'Medical_Dataset.medrxiv_url'
schema = [
...
class URL_builder():
  ...
  def __init__(self,search_word,pages):
    ...
    url_search=f'https://www.medrxiv.org/search/{search_word}%20numresults%3A75%20sort%3Arelevance-rank?'.format(search_word)
    article_set = set()
    driver_path = '/usr/lib/chromium-browser/chromedriver'
    self.url1=[]
    for page_num in range(pages):
      print(f"Scraping from page {page_num}...", flush=True)
      url = url_search+"page=" + str(page_num)
      print(url)
